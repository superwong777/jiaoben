          ...
          return (
            <HStack
              ...
              {...(!isEditing && {
                              contextMenu: {
                                menuItems: (
                                  <Group>
                                    <Button title="取消收藏" action={() => toggleFavorite(music)} />
            ...
            >
              {coverExists[music.id]
                ...
                : <Image systemName="heart.fill" font="title2" tint="systemPink" symbolRenderingMode="multicolor" frame={{ width: 40, height: 40 }} />
              }
